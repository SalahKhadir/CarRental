...
<body>
    ...
    <div class="container py-5">
        <h1 class="text-center fw-bold mb-4">Edit Vehicle</h1>

        <form action="{{ route('managecars.update', $vehicle->id) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <input type="number" class="form-control" name="price_per_day" value="{{ $vehicle->price_per_day }}" required>
            </div>
